...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: str | list[str] = "console", config=None, group_name=None):
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            ...
            wandb.define_metric("train/*", step_metric="training/global_step")
            wandb.define_metric("val/*", step_metric="training/global_step")
            wandb.define_metric("val-core/*", step_metric="training/global_step")
            wandb.define_metric("val-aux/*", step_metric="training/global_step")
            wandb.define_metric("critic/*", step_metric="training/global_step")
            wandb.define_metric("self_distillation/*", step_metric="training/global_step")
            wandb.define_metric("train/reward_vs_accuracy", step_metric="train/accuracy")
