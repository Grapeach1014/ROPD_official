...
def dispatch_nd_compute_dataproto(dp_rank_mapping: list[int], dp_size, worker_group, *args, **kwargs):
    ...
    padding_size = splitted_kwargs.pop(_padding_size_key, 0)
    dispatched_args, dispatched_kwargs = dispatch_nd_compute(
        dp_rank_mapping,
        dp_size,
        worker_group,
        *splitted_args,
    ...
    if padding_size:
        dispatched_kwargs[_padding_size_key] = padding_size
